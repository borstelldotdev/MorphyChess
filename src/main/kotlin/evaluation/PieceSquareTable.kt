...
val pawnPSq = PieceSquareTable.createTable(
    intArrayOf(
        0,   0,   0,   0,   0,   0,  0,   0,
...
val knightPSq = PieceSquareTable.createTable(
    intArrayOf(
...
val bishopPSq = PieceSquareTable.createTable(
    intArrayOf(
...
val rookPSq = PieceSquareTable.createTable(
    intArrayOf(
...
val queenPSq = PieceSquareTable.createTable(
    intArrayOf(
...
val kingPSq = PieceSquareTable.createTable(
    intArrayOf(
...
value class PieceSquareTable(val value: Array<IntArray>) {
    ...
    companion object {
        fun flipY(sq: Int): Int =
            (sq and 0b000111) or (56 - (sq and 0b111000))
        ...
        fun createTable(
            middlegameTable: IntArray,
            endgameTable: IntArray,
            middlegameStaticWeight: Int,
            endgameStaticWeight: Int,
        ): PieceSquareTable {
            val whiteMiddleGame = cloneTable(middlegameTable, middlegameStaticWeight, false)
            val whiteEndGame = cloneTable(endgameTable, endgameStaticWeight, false)
            val blackMiddleGame = cloneTable(middlegameTable, middlegameStaticWeight, true)
            val blackEndGame = cloneTable(endgameTable, endgameStaticWeight, true)

            return PieceSquareTable(arrayOf(
                whiteMiddleGame,
                whiteEndGame,
                blackMiddleGame,
                blackEndGame
